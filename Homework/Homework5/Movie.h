...
public:
    ...
    void setTitle(std::string& titlepass) {
        title = titlepass;
    }

    void setYear(int yearpass) {
        year = yearpass;
    }

    void setGenres(std::string& genrespass) {
        genres = genrespass;
    }

    void setimdbId(int idpass) {
        imdbId = idpass;
    }

    void setRating(float ratingpass) {
        rating = ratingpass;
    }

    void setNumRaters(int passednumrate) {
        numRaters = passednumrate;
    }
